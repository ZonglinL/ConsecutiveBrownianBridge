...
Please install necessary packages in requirements.txt. Download the model weights of VFIformer from <a href="https://drive.google.com/drive/folders/140bDl6LXPMlCqG8DZFAXB3IBCvZ7eWyv"> here</a>. You need to change the path of load_VFI to the path of downloaded weights, then run:
